export default function LandingPage () {
    return (
      <div id="landing" className="lg:snap-start flex flex-col col-span-10 col-start-2 lg:col-span-12 lg:grid lg:grid-cols-subgrid h-full p-12 overflow-hidden select-none">
